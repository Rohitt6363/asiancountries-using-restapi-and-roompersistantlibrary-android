...
public class CountryAdapter extends RecyclerView.Adapter<CountryAdapter.CountryHolder> {
    ...
    public CountryAdapter(ArrayList<File> files) {
        this.files = files;
    }
    ...
    public void onBindViewHolder(@NonNull CountryHolder holder, int position) {
        ...
        holder.name.setText(temp.getmName());
        holder.capital.setText(temp.getmCapital());
        holder.region.setText(temp.getmRegion());
        holder.subregion.setText(temp.getmSubregion());
        holder.population.setText(temp.getmPopulation());
        holder.borders.setText(temp.getmBorders());
        holder.languages.setText(temp.getmLanguages());
        Utils.fetchSVG(MainActivity.fcontext, temp.getmFlag(), holder.flag);
